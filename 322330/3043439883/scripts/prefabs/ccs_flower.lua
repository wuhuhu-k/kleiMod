local assets =
{
    Asset("ANIM", "anim/ccs_flowers.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("ccs_flowers")
    inst.AnimState:SetBuild("ccs_flowers")
    inst.AnimState:SetRayTestOnBB(true)

    inst:AddTag("ccs_flower")
    inst:AddTag("cattoy")
...
return Prefab("ccs_flower", fn, assets, prefabs),
       Prefab("planted_ccs_flower", plantedflowerfn, assets, prefabs)
