...
local function fn()
    ...
    inst.components.inspectable:SetDescription([[修理雨伞~修理雨伞~修理雨伞~]])
...
STRINGS.NAMES[name:upper()] ="祈雨"
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()] = "修理雨伞~修理雨伞~修理雨伞~"
